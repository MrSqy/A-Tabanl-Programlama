...
$username = 'root';
$password = '';
$dbname = 'kullanici_kayit'; // phpmyadmin uzerinde gozuken database adi
...
try {
    ...
    $conn->exec("USE $dbname"); // kullanilacak database'i secer. USE $dbname ifadesi yukarida olusturulmus olan kullanici_kayit database'ini isaret eder
